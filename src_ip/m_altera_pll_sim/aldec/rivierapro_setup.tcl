...
# ACDS 20.1 720 win32 2021.04.29.23:07:48
# ----------------------------------------
...
# ----------------------------------------
# If m_altera_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "m_altera_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/m_altera_pll.vo"
}
