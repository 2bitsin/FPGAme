...
# ACDS 20.1 720 win32 2021.04.25.23:05:18
# ----------------------------------------
...
# ----------------------------------------
# If mod_altera_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mod_altera_pll"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/devel/intelfpga_lite/20.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mod_altera_pll.vo"
}
